...
async function main() {
  ...
  let menuPage = document.querySelector(
    "section.mainContainer>nav>div.menuPage"
  );
  ...
  let searchBoxRightWrapper = document.querySelector(
  ...
  document
    .querySelector("div.shoppingBagPage")
  ...
  //delivery btn
  document
    .getElementById("deliveryClose")
    .addEventListener("click", function () {
      document.querySelector(
        "section.swiprContainer>div.delivery"
      ).style.display = "none";
    });
